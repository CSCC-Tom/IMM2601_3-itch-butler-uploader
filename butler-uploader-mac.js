...
const gamename = "2023au-2541-t1-vamp-savior";
...
function UploadTeamGame(platform, version_string, cb) {
  const butler_command_file = "./butler/versions/15.21.0/butler";
